...
export const useUiPrefsStore = defineStore('uiPrefs', () => {
  ...
  const strategyPanelCollapsed = ref(localStorage.getItem('ui.strategyPanelCollapsed') === 'true')
  ...
  watch(strategyPanelCollapsed, (value) => localStorage.setItem('ui.strategyPanelCollapsed', String(value)))
