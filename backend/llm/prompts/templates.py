...
FIX_CHECKLIST_ONLY = """你是一名资深渗透测试工程师。基于以下漏洞列表，生成详细的修复建议。
...
请为每个漏洞生成修复方案，按优先级排列。已成功利用的漏洞优先级必须为 P0。
...
{{
  "fix_checklist": [
    {{
      "name": "漏洞名称",
      "severity": "critical/high/medium/low",
      "fix_method": "具体可操作的修复步骤（至少2-3步）",
      "verification": "如何验证修复是否生效",
      "priority": "P0/P1/P2/P3",
      "notes": "技术备注（如 CVE 编号、影响范围）"
    }}
  ]
}}

约束:
- fix_checklist 至少包含 3 项
- 每个 fix_method 必须具体可操作（不是"升级到最新版"这种泛泛之谈）
- P0: 已成功利用的严重漏洞, P1: 高危, P2: 中危, P3: 低危/信息
- 用中文回复"""
