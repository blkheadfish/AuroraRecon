...
# ══════════════════════════════════════════════════════════
# 任务意图解析 Prompt（IntentParser LLM 辅助用）
# ══════════════════════════════════════════════════════════
...
# ══════════════════════════════════════════════════════════
# LLM-in-the-Loop 自适应目录探测引擎 Prompt
# ══════════════════════════════════════════════════════════
...
# ══════════════════════════════════════════════════════════
# 策略生成 Prompt（Plan Mode —— 类似 Cursor Plan 模式）
# ══════════════════════════════════════════════════════════
...
### 1. 阶段设计
典型的渗透测试流程包含以下阶段，按顺序排列：
- **recon**: 信息收集/侦察（端口扫描、服务识别、目录爆破、指纹识别、子域名枚举）
- **vuln_scan**: 漏洞扫描（自动化漏洞扫描、专项漏洞检测）
- **exploit**: 漏洞利用（针对确认的漏洞执行利用，获取初始访问权限）
- **post_exploit**: 后渗透（提权、横向移动、凭据收集、持久化）

根据用户意图，选择合适的阶段，不一定需要全部包含。
